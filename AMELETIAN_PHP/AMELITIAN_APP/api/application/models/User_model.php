...
class User_model extends CI_Model
{
    ...
    {
        $this->db->select('users.*,students.firstname,students.image,students.middlename,students.lastname,students.guardian_name,classes.id AS `class_id`,classes.class,sections.id AS `section_id`,sections.section');
        $this->db->from('users');
    ...
    public function getstudentcurrentlanguage($student_id)
    {          
        $this->db->select('users.*,languages.language,languages.short_code');
        $this->db->join('languages', 'languages.id = users.lang_id');
        $this->db->from('users');
