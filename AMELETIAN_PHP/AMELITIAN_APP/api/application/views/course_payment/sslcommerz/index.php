        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="paybox">
                        <div class="paybox_bg">
                            <h3 class="bt_title"><img src="<?php echo base_url(); ?>backend/images/sslcommerz.png" /><span>SSLCommerz Payment Gateway</span></h3>
                            <div class="paybody">
                                ...
                                <div class="">
                                    <div class="paymentbg">
                                      ...
                                      <div class=" paddtzero">
                                          <form action="<?php echo base_url(); ?>course_payment/sslcommerz/pay" method="post">
                                            <?php if(!empty($params['course_thumbnail'])){?>
                                              ...
                                              <table class="table mb0 paytable">
                                                   <tr>
                                                    ...
                                                    <tr class="paybtngray">
                                                      <td><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray">Pay With SSLCommerz <span class="bolds"><?php
