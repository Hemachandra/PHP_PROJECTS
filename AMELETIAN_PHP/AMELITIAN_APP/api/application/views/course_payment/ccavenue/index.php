        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="paybox">
                        <div class="paybox_bg">
                            <h3 class="bt_title"><img src="../backend/images/ccavenue.png" ><span>CCAvenue Payment Gateway</span></h3>
                            <div class="paybody">
                                    ...
                                    <div class=" paddtzero">
                                      <?php if(!empty($params['course_thumbnail'])){?>
                                        ...
                                        <form action="<?php echo base_url(); ?>course_payment/ccavenue/pay" method="post">
                                             ...
                                             <table class="table mb0 paytable">
                                               <tr>
                                                ...
                                                <tr class="paybtngray">
                                                  <td><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray">Pay With CCAvenue <span class="bolds"><?php
