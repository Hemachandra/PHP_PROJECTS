        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="paybox">
                        <div class="paybox_bg">
                            <h3 class="bt_title"><img src="../backend/images/jazzcash.jpg" style="margin-bottom: 10px;"><br />JazzCash Payment Gateway</h3>
                            <div class="paybody">
                                ...
                                <div class="">
                                    <div class="paymentbg">
                                        ...
                                        <div class="padd2 paddtzero">
                                            <form action="<?php echo base_url(); ?>gateway/Jazzcash/pay" method="post">
                                                <table class="table2" width="100%">
                                                    ...
                                                    <tr class="bordertoplightgray">
                                                        ...
                                                        <td bgcolor="#fff" class="text-right"><?php echo ($params['guardian_phone']); ?></td>
                                                    </tr>
                                                    <tr class="bordertoplightgray">
                                                        <td bgcolor="#fff"><?php echo ('Email'); ?>:</td>
                                                        <td bgcolor="#fff" class="text-right"> <?php echo ($student_data->guardian_email); ?></td>
                                                    </tr>
                                                    <tr><td colspan="2"><hr /></td></tr>
                                                    <tr class="bordertoplightgray">
                                                        <td bgcolor="#fff">  </td>
                                                        <td bgcolor="#fff" class="text-right"> <button type="submit"  name="search" value="" class="btn btn-info"><i class="fa fa fa-chevron-right"></i> <?php echo ('Pay With JazzCash'); ?></button>  </td>
                                                    </tr>
                                                </table>
