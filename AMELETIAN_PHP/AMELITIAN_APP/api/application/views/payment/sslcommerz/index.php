...
<html lang="en">
    <head>
        ...
        <title>Sslcommerz Pay Custom Integration</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="paybox">
                        <div class="paybox_bg">
                            <h3 class="bt_title"><img src="../backend/images/sslcommerz.png" style="margin-bottom: 10px; width:100%"><br />Sslcommerz Payment Gateway</h3>
                            <div class="paybody">
                                ...
                                <div class="">
                                    <div class="paymentbg">
                                        ...
                                        <div class="padd2 paddtzero">
                                            <form action="<?php echo base_url(); ?>gateway/Sslcommerz/pay" method="post">
                                                <table class="table2" width="100%">
                                                    ...
                                                    <tr class="bordertoplightgray">
                                                        <td bgcolor="#fff">  </td>
                                                        <td bgcolor="#fff" class="text-right"> <button type="submit"  name="search" value="" class="btn btn-info"><i class="fa fa fa-chevron-right"></i> <?php echo ('Pay With Sslcommerz'); ?></button>  </td>
                                                    </tr>
                                                </table>
