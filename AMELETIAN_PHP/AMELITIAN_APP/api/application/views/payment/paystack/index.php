        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="paybox">
                        <div class="paybox_bg">
                            <h3 class="bt_title"><img src="../backend/images/paystack.png" style="height: 40px; margin-bottom: 10px;"><br />Paystack Payment Gateway</h3>
                            <div class="paybody">
                                            ...
                                            <form action="<?php echo base_url(); ?>gateway/paystack/paystack_pay" method="post">
                                                <table class="table2" width="100%">
                                                    <tr>
                                                        ...
                                                        <th valign="top" class="text-right"><?php echo ('Amount') ?></th>
                                                    </tr>
                                                    <tr>
                                                        <td> <?php
