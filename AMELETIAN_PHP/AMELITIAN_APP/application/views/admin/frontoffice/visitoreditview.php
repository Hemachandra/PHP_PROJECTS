                        ...
                        <form id="form1" action="<?php echo site_url('admin/visitors/edit/' . $visitor_data['id']) ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="pwd">Student Admission#</label>  <small class="req"> *</small>
                                    <input type="text" class="form-control admission_no" id="admission_no" value="<?php echo set_value('admission_no', $visitor_data['admission_no']); ?>" name="admission_no_search">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="outing_reason" id="outing_reason" class="form-control">
                                        <option value="-"><?php echo $this->lang->line('select'); ?> </option>
                                        <option <?php echo ($visitor_data['outing_reason'] == "Holidays")?(' selected="selected"'):(''); ?> value="Holidays">Holidays</option>
                                        <option <?php echo ($visitor_data['outing_reason'] == "Health issue")?(' selected="selected"'):(''); ?> value="Health issue">Health issue</option>
                                        <option <?php echo ($visitor_data['outing_reason'] == "Home opening")?(' selected="selected"'):(''); ?> value="Home opening">Home opening</option>
                                        <option <?php echo ($visitor_data['outing_reason'] == "Marriage")?(' selected="selected"'):(''); ?> value="Marriage">Marriage</option>
                                        <option <?php echo ($visitor_data['outing_reason'] == "Birthday")?(' selected="selected"'):(''); ?> value="Birthday">Birthday</option>
                                        <option <?php echo ($visitor_data['outing_reason'] == "Other")?(' selected="selected"'):(''); ?> value="Other">Other</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control name" value="<?php echo set_value('name', $visitor_data['name']); ?>" name="name">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="permission_by" id="permission_by" class="form-control">
                                            <option value="-"><?php echo $this->lang->line('select'); ?> </option>
                                            <option <?php echo ($visitor_data['permission_by'] == "Principal")?(' selected="selected"'):(''); ?> value="Principal">Principal</option>
                                            <option <?php echo ($visitor_data['permission_by'] == "Sameera madam")?(' selected="selected"'):(''); ?> value="Sameera madam">Sameera madam</option>
                                            <option <?php echo ($visitor_data['permission_by'] == "Bharat sir")?(' selected="selected"'):(''); ?> value="Bharat sir">Bharat sir</option>
                                            <option <?php echo ($visitor_data['permission_by'] == "Venkatesh sir")?(' selected="selected"'):(''); ?> value="Venkatesh sir">Venkatesh sir</option>
                                            <option <?php echo ($visitor_data['permission_by'] == "Mangament")?(' selected="selected"'):(''); ?> value="Mangament">Mangament</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="return_date" class="form-control date" value="<?php echo set_value('return_date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($visitor_data['return_date']))); ?>"  name="return_date" readonly="">
