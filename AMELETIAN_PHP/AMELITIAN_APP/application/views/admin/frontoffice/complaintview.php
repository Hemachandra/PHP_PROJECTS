                        ...
                        <form id="form1" action="<?php echo site_url('admin/complaint') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Search By Student Name, Roll Number, Enroll Number, National Id, Local Id Etc." class="form-control admission_no" id="admission_no" value="<?php echo set_value('admission_no'); ?>" name="admission_no">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="pwd">Complaint by name</label> <small class="req"> *</small> 
                                            <input type="text" id="name" class="form-control name" value="<?php echo set_value('name'); ?>"  name="name">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="action_taken" name="action_taken" rows="3"><?php echo set_value('action_taken'); ?></textarea>
                                        ...
                                        foreach ($complaint_list as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <a target="_blank" href="<?php echo base_url('student/view/'.$value['student_id']); ?>">    
                                                ...
                                                <td class="mailbox-name"><?php echo $value['firstname'].$value['surname']; ?></td>
