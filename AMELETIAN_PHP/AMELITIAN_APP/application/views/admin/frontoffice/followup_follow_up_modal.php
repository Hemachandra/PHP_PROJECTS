            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="hidden" id="enquiry_id" name="followup_id" value="<?php echo $enquiry_data['id'] ?>">
        ...
        <div class="taskside">
            ...
            <div class="task-info task-single-inline-wrap task-info-start-date">
                <h5><i class="fa task-info-icon fa-fw fa-lg fa-calendar-plus-o pull-left fa-margin"></i>
                    <?php echo $this->lang->line('followup'); ?> <?php echo $this->lang->line('date'); ?>: <?php print_r(date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($enquiry_data['date']))); ?>                                      
                </h5>
            </div>
...
<script>
    function follow_save() {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/followup/follow_up_insert',
            type: 'POST',
            dataType: 'json',
    ...
    function changeStatus(status, id) {      
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/followup/change_status/',
            type: 'POST',
            dataType: 'json',
