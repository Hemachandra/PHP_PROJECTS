                        ...
                        <form id="form1" action="<?php echo site_url('admin/complaint/edit/' . $complaint_data['id']) ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Search By Student Name, Roll Number, Enroll Number, National Id, Local Id Etc." class="form-control admission_no" id="admission_no" value="<?php echo set_value('admission_no',$complaint_data['admission_no']); ?>" name="admission_no">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control name" value="<?php echo set_value('name', $complaint_data['name']); ?>"  name="name">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="action_taken"  name="action_taken" rows="3"><?php echo set_value('action_taken', $complaint_data['action_taken']); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="assigned">
                                        ...
                                        foreach($staffList as $val){ ?>
                                                <option <?php echo ($complaint_data['assigned'] == $val['id'])?(' selected="selected"'):(''); ?> value="<?php echo $val['id']; ?>"><?php echo $val['user_type']." >> ".$val['name']; ?></option>
                                        <?php } 
                                        }?>
                                    </select>
