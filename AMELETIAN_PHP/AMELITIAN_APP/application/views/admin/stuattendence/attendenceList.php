                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>
                                        <input id="date" name="date" placeholder="" type="hidden" class="form-control date"  value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>" readonly="readonly"/>
                                            ...
                                            <table class="table table-hover table-striped example"> 
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($resultlist as $key => $value) {
                                                        ...
                                                        foreach($approved_leaves as $k => $v){

                                                            if((int)trim($value['student_session_id']) == (int)trim($v->student_session_id)){
                                                                $show = 'hide';
                                                            }
                                                        }
                                                        ?>
                                                        <tr data="<?php echo $show; ?>" style="<?php echo ($show == 'hide')?('display:none;'):(''); ?>">
                                                            <td>
