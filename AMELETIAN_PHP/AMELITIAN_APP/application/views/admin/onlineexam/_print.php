         ...
         <div class="col-md-12">
            <div class="box box-primary">
               <div class="box-header ptbnull">
                  <h3 class="titlefix"> <?php echo $this->lang->line('online') . " " . $this->lang->line('exam'); ?></h3>
               </div>
               <div class="">
...
if(!$dispaly_negative_marks){
                 ...
                 <h4 class="text-center font-weight-bold"><?php echo $exam->exam; ?></h4>
                  <div class="row clear">
                     <div class="col-md-4">
                                 ...
                                 <div><span class="font-weight-bold"><?php echo $this->lang->line('exam') . " " . $this->lang->line('from') ?> : </span>
                                 

                                  <?php echo $this->customlib->dateyyyymmddToDateTimeformat($exam->exam_from,false); ?>
                                  </div>
                                 <div>
                                  <span class="font-weight-bold"><?php echo $this->lang->line('exam') . " " . $this->lang->line('to') ?> : </span>
   ...
   <div class="col-md-4">
                              <div><span class="font-weight-bold"><?php echo $this->lang->line('total') . " " . $this->lang->line('questions') ?> : </span> <?php echo $total_question; ?></div>
                              <div><span class="font-weight-bold"> <?php echo $this->lang->line('descriptive_questions'); ?>: </span> <?php echo $exam_total_descriptive; ?></div>
                                 ...
                                 if ($exam->publish_result) {
                                            ?>
                              <div><span class="font-weight-bold"><?php echo $this->lang->line('correct') . " " . $this->lang->line('answer') ?> : </span> <?php echo $correct_ans; ?></div>
                              <div><span class="font-weight-bold"><?php echo $this->lang->line('wrong') . " " . $this->lang->line('answer'); ?> : </span> <?php echo $wrong_ans; ?></div>
                              <div><span class="font-weight-bold"><?php echo $this->lang->line('not') . " " . $this->lang->line('attempted'); ?> : </span> <?php echo $not_attempted; ?></div>
  ...
  <?php
      ...
      if (($question_value->correct == $question_true_false_key) && $question_value->select_option == null) {
                           ...
                           <?php }
                              ?>
                          <div>
                              Time taken to answer: <?php echo $question_value->time; ?>
                          </div>
                        </div>
                     </div>
                  </div>
