                 ...
                 foreach ($question_result as $result_key => $question_value) {
                  ...
                  if ($question_value->question_type == "descriptive") {
                    ...
                    if ($question_value->select_option != null) {
                     ...
                     ?>
                  <button class="btn btn-primary btn-xs print_div" data-examid="<?php echo $exam->id;?>" data-student_session_id="<?php echo $student_session_id;?>" data-recordid="<?php echo $onlineexam_student_id;?>"  data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.."><i class="fa fa-print"></i></button>
                     ...
                     <div class="col-lg-8 col-md-8 col-sm-12">
                        <dl class="row mb10">
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-12">
                              <div class="row">
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('total') . " " . $this->lang->line('attempt') ?></dt>
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $exam->attempt; ?></dd>
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('exam') . " " . $this->lang->line('from') ?></dt>
                                 ...
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                                  <?php echo $this->lang->line('exam') . " " . $this->lang->line('to') ?></dt>
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
 ...
 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
  ...
  <?php
                                 ...
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $exam->passing_percentage; ?></dd>
                                  <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('exam_rank')?></dt>
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-12">
                              <div class="row">
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('total') . " " . $this->lang->line('questions') ?></dt>
                                 ...
                                 if ($exam->publish_result) {
                                            ?>
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('correct') . " " . $this->lang->line('answer') ?></dt>
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $correct_ans; ?></dd>
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('wrong') . " " . $this->lang->line('answer'); ?></dt>
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $wrong_ans; ?></dd>
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('not') . " " . $this->lang->line('attempted'); ?></dt>
  ...
  <?php
                  ...
                  <div class="row">
                     <div class="col-xs-12 col-md-12 section-box">
                        ...
                        <br />
                        <div class="">Time taken to answer: <?php echo $question_value->time; ?></div>
                     </div>
                  </div>
                  <div class="hrexamtopbottom"></div>
                  <?php
