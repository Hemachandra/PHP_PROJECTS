        ...
        foreach ($students as $student) {
            ...
            <td valign="top" class="width32">
                <table cellpadding="0" cellspacing="0" width="100%" class="tc-container" style="background: #efefef;">
                    ...
                    <tr>
                        <td valign="top" align="center"  class="overflow-wrap" style="padding: 1px 0; position: relative; z-index: 1">
                                    ...
                                    <ul class="stlist">
                                        ...
                                        <span>
                                                    ...
                                                    if ($student->dob != "" && $student->dob != "0000-00-00") {
                                                        print_r($this->customlib->getSchoolDateFormat(), (int)$this->customlib->dateYYYYMMDDtoStrtotime($student->dob));
                                                        $dob = date($this->customlib->getSchoolDateFormat(), (int)$this->customlib->dateYYYYMMDDtoStrtotime($student->dob));
                                                    }
                                                    echo $dob;
                                                    ?>
                                                </span></li>
