        ...
        if (!empty($marksheet['students'])) {
            foreach ($marksheet['students'] as $student_key => $student_value) {
                ...
                <div style="margin: 0 auto; padding: 10px 5px 5px;position: relative; z-index: 0;">
                    ...
                    ?>
                    <table cellpadding="0" cellspacing="0" width="100%"  class="tablemain" style="margin-top:130px;">
                            ...
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="100%" class="">
                                    ...
                                    if ($template->is_name) {
                                        ?>
                                        <tr>
                                            <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;">Name of the student: <span style="padding-left: 30px; font-weight: bold;"><?php echo $this->customlib->getFullName($student_value['firstname'],$student_value['middlename'],$student_value['lastname'],$sch_setting->middlename,$sch_setting->lastname);  ?></span></td>
                                        </tr>
                                        <?php
                                    }
                                    ...
                                    if ($template->is_mother_name) {
                                        ?>
                                        <tr>
                                            <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;">Mother Name: <span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['mother_name']; ?></span></td>
                                        </tr>
                                        <?php
                                    }
                                    if ($template->is_class && $template->is_section) {
                                        ?>
                                        <tr>
                                            <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;"><?php echo $this->lang->line('class'); ?> & Section: <span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['class'] . " (" . $student_value['section'] . ")"; ?> </span></td>
                                        </tr>
                                        <?php
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                if ($exam->exam_group_type != "gpa") {
                                                    ...
                                                    <th valign="middle" rowspan="2"><?php echo $this->lang->line('external_marks') ?></th>
                                                    <th valign="middle" rowspan="2"><?php echo $this->lang->line('internal_marks') ?></th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($student_value['exam_result'] as $exam_result_key => $exam_result_value) {
                                                ...
                                                <tr>
                                                    ...
                                                    if ($exam->exam_group_type != "gpa") {
                                                        ...
                                                        <td>
                                                            <?php echo $exam_result_value->external_marks; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $exam_result_value->internal_marks; ?>
                                                        </td>
                                                        <td>
                                                            <?php
                                                    ...
                                                    <td valign="top" style="text-align: left;border-right:1px solid #999">
                                                        <?php
                                                    //    echo  $exam_result_value->get_marks." | ".$exam_result_value->min_marks;
                                            ...
                                            if ($exam->exam_group_type != "gpa") {
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <?php echo number_format($total_min_marks, 2, '.', ''); ?>
                                                    </td>
                                                    <td>
