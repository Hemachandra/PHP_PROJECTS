                                                ...
                                                foreach ($resultarray as $key => $value) {
                                                    ...
                                                    foreach ($value as $key => $section) {
                                                        ...
                                                        foreach ($section['result'] as $students) {
                                                            ...
                                                            $guardian_phone[] = $students->guardian_phone;
                                                        ...
                                                        if (!empty($balancelabel)) {
                                                            ?>
                                                            <tr>
                                                                     <td><?php echo $section['class_name']; ?> <?php echo $section['section_name']; ?></td>
                                                                
                                                                        <td><table><?php foreach ($admission_no as $admission_no_detail) { ?>
                                                                                    <tr><td class="text-left-md"><?php
                                                                                    
                                                                                        echo (trim($admission_no_detail))?($admission_no_detail):('-'); ?></td></tr>
                                                                                    <?php }
                                                                                    ?>
                                                                            </table>
                                                                        </td>
                                                                             <td>
                                                                                <table><?php foreach ($name as $detail) { ?>
                                                                                        <tr><td class="text-left-md"><?php echo $detail; ?></td><tr>
                                                                                    <?php } ?>
                                                                                </table>
                                                                            </td>

                                                                            <td><table><?php foreach ($category as $admission_detail) { ?>
                                                                            ...
                                                                            <?php if ($sch_setting->roll_no) { ?>
                                                                            <td>
                                                                                <table><?php foreach ($mobileno as $roll_no_detail) { ?>
                                                                            ...
                                                                            <?php } if ($sch_setting->father_name) { ?>
                                                                                ...
                                                                                <td>
                                                                                <table>
                                                                                    <?php foreach ($father_name as $father_name_detail) { ?>
                                                                                        <tr>
                                                                                            <td class="text-left-md"><?php echo $father_name_detail; ?></td>
                                                                                        <tr>
                                                                                    <?php } ?>
                                                                                </table>
                                                                            ...
                                                                            <td>
                                                                                <table>
                                                                                    <?php foreach ($mother_name as $mother_name_detail) { ?>
                                                                                        <tr>
                                                                                            <td class="text-left-md"><?php echo $mother_name_detail; ?></td>
                                                                                        <tr>
                                                                                    <?php } ?>
                                                                                </table>
                                                                            ...
                                                                            <td>
                                                                                <table>
                                                                                    <?php foreach ($mother_phone as $mother_phone_detail) { ?>
                                                                                        <tr>
                                                                                            <td class="text-left-md"><?php echo $mother_phone_detail; ?></td>
                                                                                        <tr>
                                                                                    <?php } ?>
                                                                                </table>
