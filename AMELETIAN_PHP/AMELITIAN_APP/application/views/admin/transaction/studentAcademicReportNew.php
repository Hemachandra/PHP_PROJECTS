                ...
                <div class="box removeboxmius">
                    ...
                    <div class="row">
                        ...
                        if (isset($student_due_fee) && !empty($student_due_fee)) {
                            ...
                            $consolTotalFee = 0;
                            $consolTotalPaid = 0;
                            $consolTotalDiscount = 0;
                            $consolTotalFine = 0;
                            $consolTotalBalance = 0;
                            $consolTotalPrevious = 0;
                            ...
                            foreach($student_due_fee as $className => $reports){ 
                                ...
                                ?>
                                            ...
                                            $bl =  $previousFeeRecords[$report->admission_no]->balance??0;
                                                ...
                                                <?php
                                                $consolTotalFee = $consolTotalFee + $totalFee;
                                                $consolTotalPaid = $consolTotalPaid + $totalPaid;
                                                $consolTotalDiscount = $consolTotalDiscount + $totalDiscount;
                                                $consolTotalFine = $consolTotalFine + $totalFine;
                                                $consolTotalBalance = $consolTotalBalance + $totalBalance;
                                                $consolTotalPrevious = $consolTotalPrevious + $totalPrevious;
                                                ?>
                                            <tr>
                                                <td colspan="8"></td>
                                    ...
                                    $i++;
                                            ...
                                            <tr>
                                                <td colspan="8">Consolidated Fee Details</td>
                                            </tr>
                                            <tr>
                                                <td colspan="8"></td>
                                                <td><strong>Rs.<?php echo number_format($consolTotalFee); ?></strong></td>
                                                <td><strong>Rs.<?php echo number_format($consolTotalPaid); ?></strong></td>
                                                <td><strong>Rs.<?php echo number_format($consolTotalDiscount); ?></strong></td>
                                                <td><strong>Rs.<?php echo number_format($consolTotalFine); ?></strong></td>
                                                <td><strong>Rs.<?php echo number_format($consolTotalBalance); ?></strong></td>
                                                <td><strong>Rs.<?php echo number_format($consolTotalPrevious); ?></strong></td>
                                            </tr>
                                            </tbody> 
                                        </table>
                                    </div>                            
