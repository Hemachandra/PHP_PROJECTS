    ...
    <section class="content">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('student/move_hostel') ?>" method="post" class="">
                                    ...
                                    <!-- <form role="form" action="<?php echo site_url('student/move_hostel') ?>" method="post" class=""> -->
                                        ...
                                        <div class="col-md-3 col-md-3 col-md-offset-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="hostel_id2" name="hostel_id2">
        ...
        foreach ($hostelList as $hostel_key => $hostel_value) {
            ?>
                                                                ...
                                                                <option value="<?php echo $hostel_value['id'] ?>" <?php
                                                                echo set_value('hostel_id2', $student['hostel_id2']) == $hostel_value['id'] ? "selected='selected'" : "";
                                                                ?>>
                                                                <?php echo $hostel_value['hostel_name']; ?>
                                                                </option>
            <?php
        ...
        ?>
                                                        ...
                                                        <span class="text-danger"><?php echo form_error('hostel_id2'); ?></span>
                                                    </div>
                                                </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('room_no'); ?></label>
                                                <select  id="hostel_room_id2" name="hostel_room_id2" class="form-control" >
                                                    <option value=""   ><?php echo $this->lang->line('select'); ?></option>
                                                </select>
                                                <span class="text-danger"><?php echo form_error('hostel_room_id2'); ?></span>
                                            </div>
                                        </div>
                                    ...
                                    <script>
                                        $(document).on("click",".move_submit",function(){
                                            ...
                                            if(counter == 0){
                                                ...
                                                let section = $("#section_id option:selected").val();
                                                let class_id = $("#class_id option:selected").val();
                                                let hostel_id = $("#hostel_id option:selected").val();
                                                let hostel_room_id = $("#hostel_room_id option:selected").val();
                                               
                                                let hostel_id2 = $("#hostel_id2 option:selected").val();
                                                let hostel_room_id2 = $("#hostel_room_id2 option:selected").val();

                                                $.ajax({
                                                    url:"<?php echo site_url('student/submit_move_hostel') ?>",
                                                    type:"POST",
                                                    data:{section:section,class_id:class_id,hostel_id:hostel_id,hostel_room_id:hostel_room_id,hostel_id2:hostel_id2,hostel_room_id2:hostel_room_id2,ids:ids},
                                                    success:function(){
                                        ...
                                        ?>
                                                        ...
                                                        <script type="text/javascript">
                                                            ...
                                                            $(document).ready(function () {
                                                                ...
                                                                var hostel_id = '<?php echo set_value('hostel_id') ?>';
                                                                var hostel_room_id = '<?php echo set_value('hostel_room_id') ?>';
                                                                getSectionByClass(class_id, section_id);
                                                                getHostel(hostel_id, hostel_room_id,'#hostel_room_id');
                                                                ...
                                                                /// Get hostel rooms by hostel
                                                                $(document).on('change', '#hostel_id', function (e) {
                                                                    var hostel_id = $(this).val();
                                                                    getHostel(hostel_id, 0,'#hostel_room_id');

                                                                });
                                                                $(document).on('change', '#hostel_id2', function (e) {
                                                                    var hostel_id = $(this).val();
                                                                    getHostel(hostel_id, 0,'#hostel_room_id2');

                                                                });

                                                                function getHostel(hostel_id, hostel_room_id,room) {
                                                                    if (hostel_room_id == "") {
                                                                        hostel_room_id = 0;
                                                                    }
                                                                    ...
                                                                    if (hostel_id != "") {
                                                                        ...
                                                                        $.ajax({
                                                                            ...
                                                                            success: function (data) {
                                                                                ...
                                                                                $(room).append(div_data);
                                                                            },
                                                                            complete: function () {
                                                                                $(room).removeClass('dropdownloading');
                                                                            }
                                                                        });
                                                                    }
                                                                }
