...
$exam_percentage = ($exam_get_total * 100) / $exam_grand_total;
                        ...
                        ?></span></h5>
                                 ...
                                 <div class="col-sm-4 col-lg-4 col-md-4 border-right">
                                    <div class="description-block hide">
...
<script type="text/javascript">
    ...
    function send_parent_password() {
        var base_url = '<?php echo base_url() ?>';
        var student_id = '<?php echo $student['id']; ?>';
        var username = '<?php echo isset($guardian_credential['username'])?($guardian_credential['username']):(''); ?>';
        var password = '<?php echo isset($guardian_credential['password'])?($guardian_credential['password']):(''); ?>';
        var contact_no = '<?php echo isset($student['guardian_phone'])?($student['guardian_phone']):(''); ?>';
