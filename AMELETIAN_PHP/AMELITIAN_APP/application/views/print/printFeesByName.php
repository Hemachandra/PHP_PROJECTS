                ...
                <div id="content" class="col-lg-12 col-sm-12 ">
                    <div class="invoice">
                        <div class="row header ">
                            <div class="col-sm-12">
                                <?php if(isset($feeList->code) && ($feeList->code == "Transport and Mess Fee" || $feeList->code == "Mess Fee")){ ?> 
                                  <img  src="https://amelitian.com/kalyanama.png" style="height: 100px;width: 100%;">
                                <?php }else if(isset($feeList->code) && $feeList->code == "Lodging Fee"){ ?>
                                  <img  src="https://amelitian.com/krs.png" style="height: 100px;width: 100%;">

                                <?php }else if(isset($feeList->code) && $feeList->code == "Tuition Fee"){ ?>
                        ...
                        <div class="row">                           
                            <div class="col-xs-6 text-left">
                                ...
                                <address>
                                    ...
                                    <strong><?php  echo $this->customlib->getFullName($feeList->firstname,$feeList->middlename,$feeList->lastname,$sch_setting->middlename,$sch_setting->lastname);  ?></strong><br>
                            ...
                            <div class="col-xs-6 text-right">
                                ...
                                <address>
                                    <strong>Date: <?php
                                        ...
                                        ?></strong><br/>
                                    <strong> <?php echo $this->lang->line('payment_id'); ?>:  <?php echo $invoice_id ?></strong>
                                </address>                               
                            </div>
                        </div>
