            ...
            <div class="row">
                <div id="content" class="col-lg-12 col-sm-12 ">
                    <div class="invoice">
                        <div class="row header ">
                            <div class="col-sm-12">
                                <?php if($feeList->code == "Transport and Mess Fee" || $feeList->code == "Mess Fee"){ ?> 
                                  <img  src="https://amelitian.com/kalyanama.png" style="height: 100px;width: 100%;">
                                <?php }else if($feeList->code == "Lodging Fee"){ ?>
                                  <img  src="https://amelitian.com/krs.png" style="height: 100px;width: 100%;">

                                <?php }else if($feeList->code == "Tuition Fee"){ ?>
                            ...
                            <div class="col-xs-6 text-right">
                                ...
                                <address>
                                    <strong>Date: <?php
                                        ...
                                        ?></strong><br/>
                                        <strong>ID: </strong> 
                                        <?php if($feeList->name == "Transport and Mess Fee" || $feeList->name == "Mess Fee"){ ?>KES<?php }else if($feeList->name == "Lodging Fee"){ ?>KRS<?php }else if($feeList->name == "Tuition Fee"){ ?>MES<?php }else{ ?>
                                        <?php } ?><?php echo $number = str_pad($feeList->id, 7, "0", STR_PAD_LEFT); ?>
                        ...
                        <div class="row">
                            ...
                            if (!empty($feeList)) {
                                ...
                                <table class="table table-striped table-responsive" style="font-size: 8pt;">
                                    ...
                                    <th  class="text text-center"><?php echo $this->lang->line('note'); ?></th>
                                            ...
                                            if (is_object($fee_deposits)) {
                                                ...
                                                foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                    ...
                                                    <tr class="white-td">
                                                        ...
                                                        <td class="text text-center"><?php echo $fee_deposits_value->description; ?></td>
                                                        <td class="text text-center">
                            ...
                            ?>
                                <!-- Total: <?php //echo ucwords(convertNumber($feeList->amount)); ?> -->
                ...
                <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                            ...
                            Generated by : monteselite
                        </div>
                    </div>
                <div class="row header" style="margin-top:100px;">
                    <div class="col-sm-12" style="color:#ff0000 !important;">
                        <?php
                        ?>
