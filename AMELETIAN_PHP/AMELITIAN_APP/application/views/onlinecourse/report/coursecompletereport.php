...
(function ($) {
  "use strict";
    ...
    // $(document).on('click', '.performance_btn', function (e) {
    //     var courseid = $(this).attr('data-id');
    //     var studentid = $(this).attr('user-data-id');
    //     $.ajax({
    //         url: '<?php //echo base_url(); ?>onlinecourse/coursereport/quizperformance',
    //         type: 'post',
    //         data: {courseid: courseid,studentid:studentid},
    //         // beforeSend: function () {
    //             // $('#quiz_performance').html('Loading...  <i class="fa fa-spinner fa-spin"></i>');
    //         // },
    //         // success: function(data){
    //            // $('#quiz_performance').html(data);
    //         // }
    //     });
    // });
...
function courselist(class_section_id){
    $.ajax({
