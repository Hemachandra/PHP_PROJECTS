    ...
    foreach ($outcomes as $key => $outcomevalue) {
        ?>
                    ...
                    <?php $i++;}} else {?>
                        ...
                        <div class="form-group">
                        <label><?php echo $this->lang->line('description'); ?></label><small class="req"> *</small><textarea id="editor2" name="description" placeholder="" type="text" class="form-control"><?php if (!empty($coursesList['description'])) {echo $coursesList['description'];}?></textarea><span class="text-danger"><?php echo form_error('description'); ?></span>
                        </div>                    
        </div>
        <div class="col-md-4">
            <div class="row">
...
if (!empty($allTeacherList)) {
        ...
        foreach ($allTeacherList as $allTeacherList_value) { 
            ...
            } ?>><?php echo $allTeacherList_value['name'] . ' ' . $allTeacherList_value['surname']; ?> </option>
                        <?php
}
    }
    ?>
    ...
    foreach ($course_provider as $key => $course_provider_value) {?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label><?php echo $this->lang->line('price'); ?></label><small class="req"> *</small>
                        <input autofocus="" id="course_price" name="course_price"  placeholder="" type="text" class="form-control" value="<?php if (!empty($coursesList['price'] && $coursesList['price'] != '0.00')) {echo $coursesList['price'];}?>" /><span class="text-danger"><?php echo form_error('course_price'); ?></span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
