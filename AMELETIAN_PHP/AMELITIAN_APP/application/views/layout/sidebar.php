                    ...
                    <li class="treeview <?php echo set_Topmenu('front_office'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('complaint', 'can_view')) {
                                ...
                                <li class="<?php echo set_Submenu('admin/complaint'); ?>"><a href="<?php echo base_url(); ?>admin/complaint"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('complaint'); ?></a></li>
                ...
                if (($this->rbac->hasPrivilege('student', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('student', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('student/move_student'); ?>"><a href="<?php echo base_url(); ?>student/move_student"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('move_student'); ?></a></li>
                                <li class="<?php echo set_Submenu('student/move_hostel'); ?>"><a href="<?php echo base_url(); ?>student/move_hostel"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('move_hostel'); ?></a></li>
                                <li class="<?php echo set_Submenu('student/move_transport'); ?>"><a href="<?php echo base_url(); ?>student/move_transport"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('move_transport'); ?></a></li>
                ...
                if (($this->rbac->hasPrivilege('exam_group', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="<?php echo set_Submenu('Examinations/dtp'); ?>">
                                <a href="<?php echo site_url('admin/dtpoperator'); ?>">
                                    <i class="fa fa-angle-double-right"></i> DTP Operator
                                </a>
                            </li>
        ...
        <?php } ?>
            ...
            ?>
             <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class=""><a href="<?php echo base_url('onlinecourse/course/index'); ?>"><i class="fa fa-angle-double-right"></i>Online Course</a></li>
                    <li class=""><a href="<?php echo base_url('onlinecourse/offlinepayment'); ?>"><i class="fa fa-angle-double-right"></i>Offline Payment</a></li>
                    <li class=""><a href="<?php echo base_url('onlinecourse/coursereport/report'); ?>"><i class="fa fa-angle-double-right"></i>Online Course Report</a></li>
                    <li class=""><a href="<?php echo base_url('onlinecourse/course/setting'); ?>"><i class="fa fa-angle-double-right"></i>Setting</a></li>
                </ul>
            </li>
