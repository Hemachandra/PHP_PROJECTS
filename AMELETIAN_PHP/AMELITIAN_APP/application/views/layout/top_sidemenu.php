    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu verticalmenu" style="min-width:194px;font-size:10pt;left:3px;">
            ...
            if ($this->rbac->hasPrivilege('class_timetable', 'can_view')) {
                ...
                <li role="presentation"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>admin/timetable/create"><i class="fa fa-calendar-times-o"></i><?php echo $this->lang->line('class_timetable'); ?></a></li>
