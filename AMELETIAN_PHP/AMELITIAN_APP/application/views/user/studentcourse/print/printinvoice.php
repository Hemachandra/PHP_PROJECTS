                    ...
                    <div class="invoice">
                        <div class="row header ">
                            <div class="col-sm-12">
                                <?php
                                ?>
                                <img  src="<?php echo base_url(); ?>/uploads/print_headerfooter/student_receipt/<?php $this->setting_model->get_receiptheader(); ?>">
                                <?php
                                ?>
                            </div>
                        </div> 
                        ...
                        <div class="row">                           
                            <div class="col-xs-6 text-left">
                                ...
                                <address>
                                    ...
                                    <?php echo $this->lang->line('class'); ?>: <?php echo $courselist['class'] . " (" . $courselist['section'] . ")"; ?>
                                </address>
                            </div>
                                ...
                                <table class="table table-striped table-responsive font8pt">
                                    ...
                                    <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $courselist['payment_type']; ?></td>
                                                <td>
                                                    <?php 
                                                ...
                                                <td class="text-right"><?php echo $courselist['paid_amount']; ?></td>
                                            </tr>
                                    </tbody>
                                </table>
                                <?php } ?>
