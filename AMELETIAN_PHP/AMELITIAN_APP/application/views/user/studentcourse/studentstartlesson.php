...
<div class="wrapheader">
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-8">
			<div class="wraplogo">
				<img src="<?php echo base_url(); ?>uploads/school_content/admin_logo/<?php $this->setting_model->getAdminlogo();?>" alt="<?php echo $this->customlib->getAppName() ?>" />
