                              ...
                              <form method='post' action='<?php echo $transactionURL; ?>' name='f1'>
                                ...
                                <table class="table table-bordered table-hover mb0 paytable">
                                  ...
                                  <tr class="paybtngray">
                                    ...
                                    <td><button type="submit" name="search" value="" class="btn btn-info buttondarkgray"><?php echo $this->lang->line('pay_with_paytm'); ?> <i class="fa fa-chevron-right valign-middle"></i></button></td>
                                  </tr>        
                                </table>
                                </form>
                            </div>
