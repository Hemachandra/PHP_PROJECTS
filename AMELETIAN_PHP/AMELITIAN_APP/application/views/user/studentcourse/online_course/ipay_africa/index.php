                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg pb0 paymentbg-width">
                            ...
                            <div class="">
                              <form action="<?php echo base_url(); ?>students/online_course/ipayafrica/pay" method="post">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                       <?php
                                        ...
                                        if(!empty($params['total_amount'])){ echo $params['total_amount'];}else{echo '0.00';} ?>
                                    </td>
                                  </tr> 
                                    <tr>
                                      <td class="font-weight-bold">
                                      ...
                                      <td>
                                        <input type="text" name="phone" class="form-control" value="<?php echo $params['contact_no']; ?>"><span class="error"><?php echo form_error('phone'); ?></span>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td class="font-weight-bold">
                                      ...
                                      <td>
                                        <input type="email" name="email" class="form-control" value="<?php echo $params['email']; ?>"><span class="error"><?php echo form_error('email'); ?></span>
                                      </td>
                                    </tr>
                                    <tr class="paybtngray">
                                      <td  bgcolor="#fff"><button type="button" onclick="window.history.go(-1); return false;" name="search"  value="" class="btn btn-info buttongray"><i class="fa fa-chevron-left valign-middle"></i> <?php echo $this->lang->line('back'); ?> </button></td>
                                      <td><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray"><?php echo $this->lang->line('pay_with_ipayafrica'); ?> <i class="fa fa-chevron-right valign-middle"></i></button></td>
                                    </tr>     
                                </table>
                                </form>
                            </div>
