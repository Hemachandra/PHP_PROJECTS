                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg pb0 paymentbg-width">
                            ...
                            <div class="">
                            <form method="POST" action="<?php echo base_url(); ?>students/online_course/ccavenue/pay">  
                              <div class="img-container">
                               <img src="<?php echo base_url(); ?>/uploads/course/course_thumbnail/<?php echo $params['course_thumbnail']; ?>" class="img-responsive center-block">
                                ...
                                <table class="table table-bordered table-hover mb0 paytable">
                                    ...
                                    <tr class="paybtngray">
                                      <td><button type="button" onclick="window.history.go(-1); return false;" name="search" value="" class="btn btn-info buttongray"><i class="fa fa fa-chevron-left valign-middle"></i> <?php echo $this->lang->line('back')?></button></td>
                                      <td><button type="submit" name="search" value="" class="btn cfees pull-right buttondarkgray"><?php echo $this->lang->line('pay_with_ccavenue')?> <i class="fa fa-chevron-right valign-middle"></td>
                                  </tr>
                                </table>
                              </form>
                            </div>
