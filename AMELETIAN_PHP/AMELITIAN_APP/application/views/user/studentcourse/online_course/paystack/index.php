                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg pb0 paymentbg-width">
                            ...
                            <div class="">
                              <form action="<?php echo base_url(); ?>students/online_course/paystack/paystack_pay" method="post">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <input type="text" class="form-control"  name="email" value="<?php echo $params['email']; ?>" />
                                    ...
                                    <tr class="paybtngray">
                                      ...
                                      <td><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray"><?php echo $this->lang->line('pay_with_paystack'); ?> <i class="fa fa-chevron-right valign-middle"></i></button></td>
                                    </tr>      
                                </table>                           
                                </form>
                            </div>
