                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg pb0 paymentbg-width">
                            ...
                            <div class="">
                              <form action="<?php echo base_url(); ?>students/online_course/jazzcash/pay" method="post">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <tr class="paybtngray">
                                      <td><button type="submit" onclick="window.history.go(-1); return false;" name="search"  value="" class="btn btn-info buttongray"><i class="fa fa-chevron-left valign-middle"></i> <?php echo $this->lang->line('back'); ?> </button></td>
                                      <td><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray"><?php echo $this->lang->line('pay_with_jazzcash'); ?> <i class="fa fa-chevron-right valign-middle"></i></button></td>
                                    </tr>     
                                </table>
                                </form>
                            </div>
