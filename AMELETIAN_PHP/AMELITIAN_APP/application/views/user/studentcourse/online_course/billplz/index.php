                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg pb0 paymentbg-width">
                            ...
                            <div class="">
                              <form action="<?php echo base_url(); ?>students/online_course/billplz/pay" method="post">
                                ...
                                <table class="table table-bordered table-hover mb0 paytable">
                                    ...
                                    <tr class="paybtngray">
                                      ...
                                      <td><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray"><?php echo $this->lang->line('pay_with_billplz'); ?> <i class="fa fa-chevron-right valign-middle"></button></td>
                                  </tr>
                                </table>
                              </form>
                            </div>
