                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg pb0 paymentbg-width">
                            ...
                            <div class="">
                              <form action="<?php echo base_url(); ?>students/online_course/stripe/complete" method="POST">
                                ...
                                <tr class="paybtngray">   
                                  ...
                                  <td> 
                                     <script
                                        ...
                                        data-amount="<?php echo ($params['total_amount'] * 100); ?>"
                                        data-name="<?php echo $this->customlib->getSchoolName(); ?>"
                                        data-description="<?php echo $params['course_name']; ?>"
                                        data-image="<?php echo base_url('uploads/school_content/logo/' . $setting[0]['image']); ?>"
                                        data-locale="auto"
                                        data-zip-code="true"
                                        data-currency="<?php echo $this->setting[0]['currency']; ?>"
                                        >
                                    </script>  
                                   </td>
                                  </tr>      
