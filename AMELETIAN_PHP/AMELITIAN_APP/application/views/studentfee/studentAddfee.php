                            ...
                            <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                <thead class="header">
                                    <tr>
                                        ...
                                        <th class="text text-left"><?php echo $this->lang->line('note'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($student_due_fee as $key => $fee) {
                                        ...
                                        foreach ($fee->fees as $fee_key => $fee_value) {
                                            if($fee_value->name != "Balance Master" && $fee_value->type != "Previous Session Balance"){
                                                $fee_paid = 0;
                                                $fee_discount = 0;
                                                $fee_fine = 0;
                                                $fees_fine_amount = 0;
                                                    ...
                                                    <tr class="white-td">
                                                        ...
                                                        <td class="text text-left">
                                                            ...
                                                            <a href="#" data-toggle="popover" class="detail_popover" > 
                                                                ...
                                                                <?php echo $fee_deposits_value->invoice_no; ?>
                                                            </a>
                                                        ...
                                                        <td class="text text-right">
                                                            <div class="btn-group ">
                                                               <div class="pull-right">                          
                                                                ...
                                                                <?php } ?>
                                                                <button  class="btn btn-xs btn-default printDoc" data-invoice_id="<?php echo $fee_deposits_value->invoice_no; ?>" data-main_invoice="<?php echo $fee_value->student_fees_deposite_id ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no ?>"  title="<?php echo $this->lang->line('print'); ?>"><i class="fa fa-print"></i> </button>
                                                            </div>
                                                          </div>  
                                                        </td>
                                                    </tr>
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal balanceformpopup">
                    <div class="box-body">
                        ...
                        <input  type="hidden" class="form-control" id="fee_code" value="" readonly="readonly"/>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label for="reason">Reason to delete *</label>
...
<script type="text/javascript">
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'post',
                data: {'student_session_id': student_session_id, 'main_invoice': main_invoice, 'sub_invoice': sub_invoice,"invoice_id":invoice_id},
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#confirm-delete').on('click', '.btn-ok', function (e) {
            if($("#reason").val() == ""){
                alert("Kindly add cancellation reason.");
                return false;
            }else{
                ...
                $.ajax({
                    ...
                    dataType: 'JSON',
                    data: {'main_invoice': main_invoice, 'sub_invoice': sub_invoice,"reason":reason},
