...
class Examresult_model extends CI_Model {
    ...
    public function getSingleStudentExamResult($student_id,$subject_id) {
        $this->db->where('exam_group_class_batch_exam_student_id', $student_id);
        $this->db->where('exam_group_class_batch_exam_subject_id', $subject_id);
