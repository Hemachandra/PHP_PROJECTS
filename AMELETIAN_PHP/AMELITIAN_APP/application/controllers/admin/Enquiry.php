...
class Enquiry extends Admin_Controller {
    ...
    public function add() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $enquiry_id = $this->enquiry_model->add($enquiry);
            ...
            for($i =0; $i < count($student_name); $i++){
                if($student_name[$i] != "" && $date_of_birth[$i] != "" && $class[$i] != ""){
                    ...
                    $this->db->insert("enquiry_students",$info);
                }
            }
    ...
    public function delete($id) {
        ...
        if (!empty($id)) {
            ...
            $this->enquiry_model->enquiry_students_delete($id);
    ...
    public function follow_up($enquiry_id, $status) {
        ...
        $data['enquiry_status'] = $this->enquiry_status;
        $data['enquiry_student'] = $this->enquiry_model->get_enquiry_student($enquiry_id);
    ...
    function details($id, $status) {
        ...
        $data['staffList']         = $this->staff_model->searchFullText("", 1);
        $data['enquiry_student'] = $this->enquiry_model->get_enquiry_student($id);
