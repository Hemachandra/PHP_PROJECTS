...
class Transaction extends Admin_Controller {
    ...
    function studentacademicreport() {
        ...
        $this->form_validation->set_rules('section_id', $this->lang->line('section'), 'trim|xss_clean|required');
        ...
        if ($this->form_validation->run() == false) {
            ...
            foreach ($classlist as $key => $value) {
                ...
                $studentlist =         $this->student_model->reportClassSection($classid,$section_id);
    ...
    function studentacademicreport_new() {
