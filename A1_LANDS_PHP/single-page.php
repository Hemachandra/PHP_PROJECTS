...
if (!isMobile() || $itemDetails['page_template'] != 'search') {
	include './header.php';
...
if ($itemDetails['page_private'] == 1 && !isLogged()) {
	...
	}elseif ($itemDetails['page_template'] == 'specialproperties') {
		
		require './pages/specialproperties.php';

	}elseif ($itemDetails['page_template'] == 'shorlistproperties') {

		require './pages/shortlistproperties.php';
...
// if ($itemDetails['page_template'] != 'search') {
// 	if(!isMobile()){
// 		include './sections/views/footer-ad.view.php';
...
// 		include './footer.php';
// 	}else {
// 		include './sections/views/mobile-footer-view.php';
// 	}
// }
