...
<div class="form-row">
   ...
   <select class="custom-select form-control selectDrop" name="slider_property" id="select2">
   <option value="0" selected>-</option>
   <?php foreach($properties as $property): ?>
   <option value="<?php echo $property['pt_id']; ?>"><?php echo $property['tr_title']; ?></option>
   <?php endforeach; ?>
   </select>
<br/>
<br/>
