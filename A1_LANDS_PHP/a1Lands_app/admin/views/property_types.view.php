...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     "bProcessing": true,
     "sAjaxSource": "../controller/get_property_types.php",
     "responsive": true,
     "bPaginate":true,
     "aaSorting": [[1,'desc']],
     ...
     "iDisplayLength": 10,
     "aoColumns": [
     { mData: 'pt_type_id', "width": "5%", "className": "text-center" },
    { mData: 'tr_name'},
    { "mData": null ,
    "width": "14%",
    ...
    "mRender" : function (data) {
      return "<a data-toggle='modal' data-target='#view-modal' id='showEditModal' class='btn btn-small btn-primary' style='color:#fff' data-id='"+data.pt_type_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-url='../controller/delete_property_type.php?id="+data.pt_type_id+"'>"+DELETEITEM+"</a>";}
    }
    ]
  });
  });
    ...
    <div class="content sm-gutter">
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="section-title">
          <h5 class="text-truncate"><?php echo _PROPERTY_TYPES; ?></h5>
        </div>
  ...
  $(document).ready(function(){
   $('#insert_form').on("submit", function(event){  
    event.preventDefault();  
     $.ajax({  
      url:"../controller/new_property_type.php",  
      method:"POST",  
...
$(document).ready(function(){
  $(document).on('click', '#showEditModal', function(e){
      ...
      $('#modal-loader').show();
      $.ajax({
          url: '../controller/get_property_type_languages.php',
          type: 'POST',
          data: 'id='+uid,
          dataType: 'html'
      })
