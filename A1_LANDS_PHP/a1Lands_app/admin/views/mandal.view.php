...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     "bProcessing": true,
     "sAjaxSource": "../controller/get_mandal.php",
     "responsive": true,
     "bPaginate":true,
     "aaSorting": [[1,'desc']],
     ...
     "iDisplayLength": 10,
     "aoColumns": [
     { mData: 'pt_mandal_id', "width": "5%", "className": "text-center" },
    { mData: 'tr_name'},
    { "mData": null ,
    "width": "14%",
    ...
    "mRender" : function (data) {
      return "<a data-toggle='modal' data-target='#view-modal' id='showEditModal' class='btn btn-small btn-primary' style='color:#fff' data-id='"+data.pt_mandal_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-url='../controller/delete_mandal.php?id="+data.pt_mandal_id+"'>"+DELETEITEM+"</a>";}
    }
    ]
  });
  });
    ...
    <div class="content sm-gutter">
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="section-title">
          <h5 class="text-truncate"><?php echo _MANDAL; ?></h5>
        </div>
...
$(document).ready(function(){
  $(document).on('click', '#showEditModal', function(e){
      ...
      $('#modal-loader').show();
      $.ajax({
          url: '../controller/get_mandal_languages.php',
          type: 'POST',
          data: 'id='+uid,
          dataType: 'html'
      })
