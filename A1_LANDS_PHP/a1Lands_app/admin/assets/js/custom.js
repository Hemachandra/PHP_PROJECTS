...
$(document).ready(function()
{
 ...
 {
  var city_id=$(this).val();
  var dataString = 'zone_id='+ city_id;

  $.ajax
  ({
   type: "POST",
   url: "get_mandal_dd.php",
   data: dataString,
   cache: false,
   success: function(html)
   {
...
$(document).ready(function()
{
 ...
 {
  var city_id=$(this).val();
  var dataString = 'mandal_id='+ city_id;
...
$(document).ready(function() {
  ...
  $('input[name="files"],input[name="files1"],input[name="files2"],input[name="files3"],input[name="files4"],input[name="files5"],input[name="brochure"]').fileuploader({
    addMore: false
  });
