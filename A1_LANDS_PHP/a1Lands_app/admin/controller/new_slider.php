...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	$slider_property = cleardata($_POST['slider_property']??0);
	...
	set_msg('success',msg: 'Slider has been added successfully!');
...
require '../views/new.slider.view.php';
	...
	set_msg('error',msg: 'You dont have permission to access this page.!');
