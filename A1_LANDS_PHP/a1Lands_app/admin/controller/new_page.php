...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$brochure = new FileUploader('brochure', array(
		'uploadDir' => '../../images/',
		'title' => 'auto',
		'maxSize' => 4,
		'fileMaxSize' => 4,
...
$sentence->execute(array(
		...
		if ($databrochure['isSuccess'] && count($databrochure['files']) > 0) {
			$brochure = $databrochure['files'][0]['name'];
			$sentence = $connect->prepare( "UPDATE pages SET icon = :icon WHERE page_id = :page_id");
