...
<ul class="ev-meta" style="display:none;">
...
<style>
    ul.ev-details-list > li > span{
        font-weight:bold !important;
    }

    ul.ev-details-list > li {
        padding-top:10px;
        padding-bottom:10px;
...
<?php if (empty($itemDetails['pt_approach'])) { ?> 
<?php } else { ?>
    <li><span>Approach Road :</span><?php echo getUnit($itemDetails['pt_approach']); ?></li>
<?php } ?>

<?php if (empty($itemDetails['pt_distance'])) { ?> 
<?php } else { ?>
    <li><span>Distance from ORR :</span><?php echo getUnit($itemDetails['pt_distance']); ?></li>
<?php } ?>

<?php if (empty($itemDetails['pt_road'])) { ?> 
<?php } else { ?>
    <li><span>Road :</span><?php echo getUnit($itemDetails['pt_road']); ?></li>
<?php } ?>

<?php if (empty($itemDetails['pt_route'])) { ?> 
<?php } else { ?>
    <li><span>Route : </span><?php echo getUnit($itemDetails['pt_route']); ?></li>
<?php } ?>

<?php if (empty($itemDetails['pt_soil'])) { ?> 
<?php } else { ?>
    <li><span>Soil Type : </span><?php echo getUnit($itemDetails['pt_soil']); ?></li>
<?php } ?>

<?php if (empty($itemDetails['pt_electricity'])) { ?> 
<?php } else { ?>
    <li><span>Electricity :</span><?php echo getUnit($itemDetails['pt_electricity']); ?></li>
<?php } ?>

<?php if (empty($itemDetails['pt_crop'])) { ?> 
<?php } else { ?>
    <li><span>Crop / Plantation :</span><?php echo getUnit($itemDetails['pt_crop']); ?></li>
<?php } ?>

<?php if (empty($itemDetails['pt_zone1'])) { ?> 
<?php } else { ?>
    <li><span>Zone : </span><?php echo getUnit($itemDetails['pt_zone1']); ?></li>
<?php } ?>

<?php if (empty($itemDetails['pt_bore'])) { ?> 
<?php } else { ?>
    <li><span>Bore / Well : </span><?php echo getUnit($itemDetails['pt_bore']); ?></li>
<?php } ?>

<?php if (empty($itemDetails['pt_fancing'])) { ?> 
<?php } else { ?>
    <li><span>Fencing :</span><?php echo getUnit($itemDetails['pt_fancing']); ?></li>
<?php } ?>

<?php if (empty($itemDetails['pt_building'])) { ?> 
<?php } else { ?>
    <li><span>Building :</span><?php echo getUnit($itemDetails['pt_building']); ?></li>
<?php } ?>

<?php 
    $features = json_decode($itemDetails['top_features'], true);
   foreach ($features as $feature){ ?>
        <li><span><?php echo $feature['title']; ?> :</span><?php echo $feature['description']; ?></li>
   <?php } ?>
</ul>
...
<?php }else{ ?>
    <a href="https://a1lands.com/signin">
        <img src="https://a1lands.com/images/blur.png">
    </a>
<?php } ?>
