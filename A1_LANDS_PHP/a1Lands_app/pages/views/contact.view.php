...
<input type="hidden" name="pageName" value="<?php echo str_replace("&","",str_replace("slug=","",$_SERVER['QUERY_STRING'])); ?>">
<input type="hidden" name="url" value="<?php echo str_replace("&","",str_replace("slug=","",$_SERVER['QUERY_STRING'])); ?>">
