...
<input class="uk-input uk-form-large uk-border-rounded" placeholder="<?php echo echoOutput($translation['tr_81']); ?>" id="phone" name="phone"  minlength="10" maxlength="10" pattern="\d{10}" type="text">
</div>
</div>
</div>
