...
<div class="ev-sidemenu" id="sidemenu" uk-offcanvas="overlay: true;">
    ...
    <div class="uk-offcanvas-bar uk-flex uk-flex-column" style="width: 400px; !important;">
        ...
        <ul class="ev-main-menu uk-nav-default uk-margin-small-bottom" uk-nav>
            ...
            <li class="dropdown" onclick="toggleServicesSublist(this)">
                <a href="#"><span>Services</span> 
                    <span style="float: right; !important"><i class="bi bi-chevron-down toggle-dropdown"></i></span>
                </a>
                <ul class="nested">
                    <?php 
                        $counter = 1;
                        foreach($navigationHeader as $item):
                            ...
                            if ($item['navigation_type'] == 'custom') { 
                                ...
                                foreach ($dropdownOptions as $it): ?>
                                    <li style="padding-left: 20px; !important; padding-top: 5px; !important; color: #000; !important;">
                                        <a style="font-size: 1rem; !important; color: #000; !important;" href="<?php echo "https://a1lands.com/" . $it['navigation_url']; ?>" 
