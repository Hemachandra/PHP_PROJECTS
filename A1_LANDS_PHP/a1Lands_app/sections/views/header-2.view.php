   ...
   <nav class="ev-nav uk-navbar-container uk-padding-small">
    ...
    // die(print_r($navigationHeader));
        foreach($navigationHeader as $k => $v){
            ...
            || $v['navigation_url'] == "legal-title-check" || $v['navigation_url'] == "investment-insights" ){
                     ...
                     <div class="uk-grid-small uk-flex-middle" uk-grid>
                        ...
                        <div class="uk-width-expand">
                           ...
                           <p class="uk-text-meta uk-margin-remove-top">
                              <a href="mailto:info@company.com"><?php echo $settings['st_email']; ?></a>
                           </p>
                        </div>
                     </div>
                  </div>
                        ...
                        <div>
                            <ul class="uk-nav uk-navbar-dropdown-nav">
                                ...
                                foreach ($two as $it):
                                    // if ($counter <= 11) {
                                        ?>
                                    <li><a href="<?php echo "a1lands.com/" . $it['navigation_url']; ?>" target="<?php echo $it['navigation_target']; ?>"><?php echo echoOutput($it['navigation_label']); ?></a></li>
                                    <li class="uk-nav-divider"></li>
                                <?php
                                // $counter++; }
                                    endforeach; ?>
