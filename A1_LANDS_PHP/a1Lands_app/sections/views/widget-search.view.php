...
<h5 class="ev-title uk-heading-line"><span><?php echo echoOutput($translation['tr_98']); ?></span></h5>
...
<option value="<?php echo $item['pt_zone_id']; ?>"><?php echo echoOutput($item['tr_name']); ?></option>
<?php endforeach; } ?>
