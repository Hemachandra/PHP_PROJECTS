...
class Routes {
    ...
    public function __construct() {
        ...
        $this->specialproperties = PROPERTIES_PAGE;
        $this->shorlistproperties = SHORTLISTED_PAGE;
...
// Pages
    ...
    public function specialproperties($array = NULL) {
        if (!$this->specialproperties || !empty($this->specialproperties)) {
        $url = $this->domain.'/'.$this->specialproperties;
        if (isset($array) && !empty($array)) {
                $url .= '?'.http_build_query($array) . "\n";
        }
        return $url;
    ...
    public function shorlistproperties($array = NULL) {
        if (!$this->shorlistproperties || !empty($this->shorlistproperties)) {
        $url = $this->domain.'/'.$this->shorlistproperties;
        if (isset($array) && !empty($array)) {
            $url .= '?'.http_build_query($array) . "\n";
        }
        return $url;
